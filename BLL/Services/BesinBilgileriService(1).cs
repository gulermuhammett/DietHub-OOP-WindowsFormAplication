...
namespace BLL.Services
{
    public class BesinBilgileriService : BaseService<BesinBilgileri>
    {
        ...
        {
            if (string.IsNullOrEmpty(entity.BesinAdi) || string.IsNullOrEmpty(entity.Kalori.ToString()) || string.IsNullOrEmpty(entity.OlcuBirimi) || string.IsNullOrEmpty(entity.Gram.ToString()))
            {
